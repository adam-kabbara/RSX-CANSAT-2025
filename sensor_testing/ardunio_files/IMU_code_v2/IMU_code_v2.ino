...
void loop() {
  ...
  if (bno08x.getSensorEvent(&sensorValue)) {
    ...
    double x1 = sensorValue.un.rawMagnetometer.x; // X-axis
    double y1 = sensorValue.un.rawMagnetometer.y; // Y-axis
    double z1 = sensorValue.un.rawMagnetometer.z; // Z-axis

    /*
    // Output the raw x, y, z values as CSV for Serial Plotter
    Serial.print(x1);
    Serial.print(",");
    Serial.print(y1);
    Serial.print(",");
    ...
    */
    ...
    double magCircleAngle1 = atan2(x-0.03*(1.62/1.99),y+0.005*(1.99/1.62))*180.0/PI;
    double magCircleAngle = map(magCircleAngle1, -180,180, 0, 360);
